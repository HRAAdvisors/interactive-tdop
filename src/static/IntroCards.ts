const IntroCards = {
  ...
  Broadband :{
      ...
      altText: 'Broadband',
      title: 'Broadband',
      description: 'Always-on, high-speed internet service. The FCC’s benchmark for high-speed internet is at least 25 megabits per second (Mbps) for downloads and 3 Mbps for uploads. ',
  },
  Affordable_Access  :{
  ...
  Cybersecurity :{
      ...
      title: 'Cybersecurity',
      description: 'Cybersecurity is knowing how to protect yourself safety online. This includes privacy and protection from scams, harassment and other online risks',
  },
};
