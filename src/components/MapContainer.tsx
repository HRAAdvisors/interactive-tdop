...
const getAggregateData = (choroplethData: any) =>  choroplethData
...
const MapContainer = () => {
  ...
  const [getBoundaries , {data: boundaryData = null, isLoading: isLoadingBoundary }]= useGetBoundaryDataBulkMutation();
  const [getChartData , {data: choroplethData = null, isLoading: isLoadingChartData }]= useGetChartDataBulkMutation();
        ...
        map.current.on("mousemove", "regionLayer", (e) => {
          if (e.features.length > 0) {
            ...
            map.current?.setPaintProperty("regionLayer", "fill-opacity", [
              ...
              [
                "==",
                ["get", "noInternetProportion"],
                feature?.properties?.noInternetProportion,
              ],
