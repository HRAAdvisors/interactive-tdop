  ...
  },
  {
    ...
    content: (
      <>
        <div>
          <p>
            Yet <strong>not all Texas residents experience the same digital opportunity.</strong>{' '}
      ...
      <>
        <div>
          <p>
            ...
            Opportunity Plan or TDOP, which shares a vision for a new state of digital opportunity
            in Texas in which every Texan has access to:
          </p>
